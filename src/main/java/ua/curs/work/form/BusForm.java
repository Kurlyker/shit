...
public class BusForm {
    ...
    public BusForm(String id, String number, String model, String color, Driver driver, PassangerClass passangerClass, ComfortClass comfortClass, OverallLength overallLength, int numberOfSeat) {
        this.id = id;
        this.number = number;
        this.model = model;
        this.color = color;
