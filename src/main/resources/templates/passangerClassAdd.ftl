...
<div align="center">
        ...
        <form name="passangerClass" action="" method="POST" class="tableAdd">
            Назва класу<br><@spring.formInput "passangerClassForm.passangerClass" "required" "text"/>
            <br>
            Опис<br><@spring.formTextarea "passangerClassForm.description" "required"/>
            <br>
            <br>
            <br>
