...
<div align="center">
        ...
        <form name="comfortClass" action="" method="POST" class="tableAdd">
            Назва класу<br><@spring.formInput "comfortClassForm.comfortClass" "required" "text"/>
            <br>
            Опис<br><@spring.formTextarea "comfortClassForm.description" "required"/>
            <br>
            <br>
            <br>
