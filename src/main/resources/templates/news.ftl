...
<main class="hoc container clear" style="margin-top: 150px">
    ...
    <section id="introblocks">
        ...
        <#list newses as news>
            ...
            <li class="one_third" style="background-color: white; width: 28%; height: 400px; margin-top: 20px;">
                <figure><a class="imgover block-animation" href="news/${news.id}"><img style="height: 25%; width: 100%" src=${news.photoUrl} alt=""></a>

                    <figcaption>
                        <h6 class="heading" style="margin-left: 5px; margin-top: 5px">${news.name}</h6>
                        <p style="margin-left: 5px; margin-top: 5px">${news.minText}</p>
                    </figcaption>
                </figure>
            </li>
            </#list>
