...
<style>
    ...
    */
    ...
    .imgover::before, .imgover::after{display:block; position:absolute; content:""; text-align:center; opacity:0;transition-duration: 0.5s;}
    .imgover::before{top:0; right:0; bottom:0; left:0;}
    .imgover::after{top:50%; left:50%; width:50px; height:50px; line-height:50px; margin:-25px 0 0 -25px; font-family:"Font Awesome 5 Free"; font-weight:900; content:"🔎";/* fa-eye */ font-size:28px;transition-duration: 0.5s;}
    .imgover:hover::before, .imgover:hover::after{opacity:1;transition-duration: 0.5s;}
    ...
    */
    ...
    .one_third{width:30.52631%; box-shadow: 0 12px 16px 0 rgba(0,0,0,0.24), 0 17px 50px 0 rgba(0,0,0,0.19);}
...
<main class="hoc container clear" style="margin-top: 150px">

    <section id="introblocks">
        <h1 align="center">ПЕРЕГЛЯД НОВИНИ</h1>
        <ul class="nospace group" style="align: center; margin-bottom: 50px">
            <li class="one_third" style="background-color: white; width: 90%; height: auto; margin-top: 20px;">
                <figure align="center" style="margin-bottom: 50px;"><img align="center" style="margin-top: 20px" src=${newsForm.photoUrl} alt="">

                    <figcaption>
                        <h6 class="heading" style="margin-left: 5px; margin-top: 5px">${newsForm.name}</h6>
                        <p style="margin-left: 5px; margin-top: 5px; text-indent: 1.5em; margin-left: 30px; margin-bottom: 30px; margin-right: 30px;" align="justify">${newsForm.allText}</p>
                    </figcaption>
                </figure>
            </li>
