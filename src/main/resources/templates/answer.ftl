...
<div align="center" style="margin-top: 5%">
    <legend>Відповідь на питання</legend>
    <form name="answer" action="" method="POST" class="tableAdd">
        <p style="margin-bottom: 3px; margin-top: 10px">Пошта</p>
        <@spring.formInput "supportForm.email" "readonly" "text"/>
        <br>
        <p style="margin-bottom: 3px; margin-top: 10px">Питання</p>
        <@spring.formTextarea "supportForm.text" "readonly"/>
        <br>
        <p style="margin-bottom: 3px; margin-top: 10px">Відповідь</p>
        <@spring.formTextarea "supportForm.answer" "required"/>
        <br>
        <br>
