...
<div>
    ...
    <table align="center" class="table table-hover" style="width: 80%"  class="shadow">
            <thead class="thead-light" style="width: 500px"  class="shadow">
            <tr class="shadow">
                <th style="vertical-align: middle; margin-left: 10px;"><p style="font-size: 25px">${route.fromCity.name}</p><br>ДАТА ВІДПРАВКИ<br>${route.dateDeparture}<br><p style="font-size: 25px">${route.timeDeparture}</p></th>
                <th style="vertical-align: middle;"><img src="https://www.shareicon.net/data/512x512/2015/11/08/669019_arrows_512x512.png" style="width: 100px; opacity: 70%"><br></th>
                <th style="vertical-align: middle;"><p style="font-size: 25px">${route.toCity.name}</p><br> ДАТА ПРИБУТТЯ<br>${route.dateOfArrival}<br><p style="font-size: 25px">${route.timeOfArrival}</p></th>
                <th style="vertical-align: middle;">АВТОБУС:<br>НОМЕР: ${route.bus.number}"<br><br>МОДЕЛЬ: ${route.bus.model}<br><br>КОЛІР: ${route.bus.color}<br><br>ВОДІЙ: ${route.bus.driver.surname} ${route.bus.driver.name} ${route.bus.driver.byFather}</th>
                <th style="vertical-align: middle;">МІСЦЬ ЗАЛИШИЛОСЬ<br>${route.seats}</th>
                <th style="font-size: 25px; vertical-align: middle;">${route.price}₴‎</th>
                <th style="vertical-align: middle;"><a  onclick="this.href=confirm('Забронювати 1 білет на автобус?') ? '/ticket/buy/${route.id}' : '/dashboard';"><button class="butt">ОБРАТИ</button></a></th>
            </tr>
            </thead>
    </table>
    </#list>
